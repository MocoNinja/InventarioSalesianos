...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = ' <div class="form-group"><div class="input-group">  <span class="input-group-addon">Buscar</span> <input type="search" class="form-control '+classes.sFilterInput+'"/></div></div>';
	...
	DataTable.defaults = {
		 ...
		 *
		 *  @example
		 *    // Show an console.log with the filtering value that was saved
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "stateSave": true,
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *    } );
				 */
				"sSortAscending": ": activar para ordenar ascendentemente columna",
	...
	DataTable.ext = _ext = {
		 ...
		 * Error reporting.
		 * 
		 * How should DataTables report an error. Can take the value 'console.log',
