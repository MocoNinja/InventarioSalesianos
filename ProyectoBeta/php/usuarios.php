              ...
              <img src="./img/add_usuario.png" alt="Meter usuario" id="add_usuario" width="50" onclick="meterUsuario()"> Insertar usuario <br/>
                ...
                <table class="USUARIOS">
                  ...
                  <?php
                    ...
                    {
                      $botonBorrar =  "<td><a href='borrarUsuario.php?clave=$linea[idUsuario]'><img src='./img/usuario_borrar.png' width='30'></a></td>";
                      $nombre = $linea['nombre'];
                      $apellidos = $linea['apellidos'];
                      $rol = $linea['rol'];
                      $usuario = $linea['username'];
                      $password = $linea['password'];
                      echo"<tr><td>$nombre</td><td>$apellidos</td><td>$rol</td><td>$usuario</td><td>$password</td><td>$botonBorrar</td></tr>";
                    }
